...
def index(path):
                ...
                if (child2.tag == 'item'):
                    for child3 in child2:
                        ...
                        if (child3.tag == 'description'):
                            if(child3.text != None):
                                et.SubElement(doc[i], "field", name="news").text = child3.text.replace("\n", " ")
                        ...
                        if (child3.tag == 'item'):
                            for child4 in child3:
                                ...
                                if (child4.tag == 'description') and i2 < len(doc):
                                        if(child4.text != None):
                                            et.SubElement(doc[i2], "field", name="news").text = child4.text.replace("\n", " ")
    ...
    tree.write("/home/paoloc/Flask_Server/Indexing/File_to_be_indexed.xml", encoding='utf-8') # Writing of the new xml file to be indexed

    filename = "/home/paoloc/Flask_Server/Indexing/File_to_be_indexed.xml"
